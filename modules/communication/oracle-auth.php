...
function sixscan_communication_oracle_auth_get_link() {
	...
	return sixscan_communication_oracle_auth_dashboard_get( $current_nonce );
}

function sixscan_communication_oracle_auth_dashboard_get( $nonce ) {
